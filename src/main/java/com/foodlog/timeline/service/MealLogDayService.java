...
public class MealLogDayService {
    ...
    public List<MealLog> findAll() {
        ...
        baseDate = baseDate.minus(10, ChronoUnit.DAYS);

        Instant yesterday = baseDate.truncatedTo(ChronoUnit.DAYS).toInstant().minus(30, ChronoUnit.DAYS);
        System.out.println(yesterday);

        Instant tomorrow = baseDate.truncatedTo(ChronoUnit.DAYS).toInstant().plus(30, ChronoUnit.DAYS);
